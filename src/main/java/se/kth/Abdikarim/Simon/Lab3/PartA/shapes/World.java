package se.kth.Abdikarim.Simon.Lab3.PartA.shapes; // TODO: Change to your package name
...
public class World {
    ...
    public World(double width, double height) {
        ...
        FillableShape rectangle = new Rectangle( 0,0, 50,50, Color.RED, false );
        FillableShape circle = new Circle( 200,200, Color.GREEN, false,100 );
        Shape line = new Line( 100,50, 100, 100, Color.BLUE );
        rectangle.setFilled( true );
        shapes = new Shape[] { rectangle, circle, line };
        shapes[0].setVelocity( 20,60 );
        shapes[1].setVelocity( 45,30 );
        shapes[2].setVelocity( 45,40 );
